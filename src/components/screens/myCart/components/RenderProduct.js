...
const RenderProducts = data => {
  ...
  return (
    <Observer>
      {() => (
        <View key={data.id} style={styles.c_container1}>
          ...
          <View style={styles.c_container2}>
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  style={styles.c_icon1}
                  onPress={() => productsStore.decrementQuantity(data)}>
                  <View style={styles.c_container_3}>
                    <MaterialCommunityIcons
                      name="minus"
                      style={styles.c_container_4}
                    />
                  </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  style={styles.c_icon2}
                  onPress={() => productsStore.incrementQuantity(data)}>
          ...
          <TouchableOpacity
            onPress={() => delProduct(data)}
            style={styles.c_icon3}>
