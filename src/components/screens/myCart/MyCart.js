...
const MyCart = () => {
  ...
  }, [productsStore.productsCart, navigation]);
  ...
  return (
    <View
      ...
      <View style={styles.c_container1}>
        ...
        <Text style={{fontSize: 20, color: COLOURS.black, fontWeight: '400'}}>
          Order Details
        </Text>
      </View>
      ...
      <View style={styles.c_container_3}>
        <TouchableOpacity style={styles.c_container2}>
          <Text style={styles.c_text3}>
            CHECKOUT (${productsStore.totalCart})
          </Text>
        </TouchableOpacity>
      </View>
    </View>
